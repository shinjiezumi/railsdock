...
ActiveRecord::Schema.define(version: 2020_03_17_100313) do

  create_table "board_tag_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
